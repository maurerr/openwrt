...
proto_qmi_setup() {
	...
	local device devpath apn auth username password pincode delay modes pdptype
	...
	json_get_vars device devpath apn auth username password pincode delay modes
